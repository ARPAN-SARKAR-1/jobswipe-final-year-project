...
class Settings(BaseSettings):
    ...
    max_profile_photo_mb: int = Field(default=2, alias="MAX_PROFILE_PHOTO_MB")
    max_company_logo_mb: int = Field(default=2, alias="MAX_COMPANY_LOGO_MB")
    max_resume_mb: int = Field(default=5, alias="MAX_RESUME_MB")
    max_verification_document_mb: int = Field(default=5, alias="MAX_VERIFICATION_DOCUMENT_MB")
    max_student_proof_mb: int = Field(default=3, alias="MAX_STUDENT_PROOF_MB")
    max_certificate_mb: int = Field(default=5, alias="MAX_CERTIFICATE_MB")
