...
class CandidateRiskAssessment(TimestampMixin, Base):
    __tablename__ = "candidate_risk_assessments"

    id: Mapped[int] = mapped_column(primary_key=True, index=True)
    job_seeker_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="CASCADE"), unique=True, nullable=False)
    ...
    job_seeker = relationship("User", foreign_keys=[job_seeker_id], back_populates="candidate_risk_assessment")
