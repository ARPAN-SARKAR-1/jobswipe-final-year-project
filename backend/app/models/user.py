...
class User(TimestampMixin, Base):
    ...
    public_user_id: Mapped[str | None] = mapped_column(String(12), unique=True, index=True, nullable=True)
    ...
    documents = relationship("UserDocument", foreign_keys="UserDocument.owner_user_id", back_populates="owner", cascade="all, delete-orphan")
    reviewed_documents = relationship("UserDocument", foreign_keys="UserDocument.reviewed_by", back_populates="reviewer")
