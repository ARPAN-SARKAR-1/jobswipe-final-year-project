...
class CompanyProfile(TimestampMixin, Base):
    ...
    employee_count_estimate: Mapped[int | None] = mapped_column(Integer, nullable=True)
    headquarters: Mapped[str | None] = mapped_column(String(160), nullable=True)
    ...
    ambitionbox_url: Mapped[str | None] = mapped_column(String(500), nullable=True)
    ...
    testimonials = relationship("CompanyTestimonial", back_populates="company", cascade="all, delete-orphan")
