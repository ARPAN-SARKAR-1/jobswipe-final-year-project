...
const sections = [
  ["What data we collect", "Name, email, role, profile details, academic status, degree, stream, CGPA, education, skills, experience, GitHub profile link, resume PDF, marksheets, certificates, profile picture, company details, application activity, swipe activity, reports, notifications, and chat messages."],
  ["Why we collect data", "We use this data for account creation, job and internship matching, application tracking, recruiter communication, platform safety, moderation, and support."],
  ["Document visibility", "Your resume, marksheets, and certificates are not public. They become visible only to recruiters when you apply to their job. Owner/Admin may access documents only for moderation or support if required."],
